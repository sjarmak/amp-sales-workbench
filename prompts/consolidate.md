...
5. **Portfolio Context** - Cross-account patterns from analyzing similar deals (use cases, objections, success factors, competitors)
...
- **Competitive mentions** - Are competitors being discussed? Consider portfolio-wide competitor mentions for context.
- **Objections** - What concerns or blockers exist? Cross-reference with common objections from the portfolio to suggest resolution patterns.
- **Champions** - Who are the internal advocates?
- **Risks** - What threatens the deal or relationship?
- **Next actions** - What should the sales team do next? Consider success factors from similar deals in the portfolio.
