...
let callId: string | undefined
	...
	console.error('Example: npx tsx scripts/test-precall-brief.ts "Acme Corp" "2025-10-22"')
	console.error('Example with call: npx tsx scripts/test-precall-brief.ts "Acme Corp" "2025-10-22" "call-123"')
	 process.exit(1)
	}
